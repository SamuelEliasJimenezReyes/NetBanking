...
namespace NetBanking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231118060812_SecondMigration")]
            ...
            modelBuilder.Entity("NetBanking.Core.Domain.Entities.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8940),
                            CreatedBy = "Admin",
                            Status = true,
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8963),
                            CreatedBy = "Admin",
                            Status = true,
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8965),
                            CreatedBy = "Admin",
                            Status = true,
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8968),
                            CreatedBy = "Admin",
                            Status = true,
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8970),
                            CreatedBy = "Admin",
                            Status = true,
                        ...
                        {
                            Id = 6,
                            Created = new DateTime(2023, 11, 18, 2, 8, 10, 931, DateTimeKind.Local).AddTicks(8973),
                            CreatedBy = "Admin",
                            Status = true,
